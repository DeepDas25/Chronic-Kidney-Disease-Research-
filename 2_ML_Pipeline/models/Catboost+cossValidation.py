# ============================================================
# CATBOOST 5-FOLD STRATIFIED LEAKAGE-FREE CROSS VALIDATION
# ============================================================
...
# Load raw dataset (relative to the script directory)
raw_csv_path = _find_data_file("ckd_nhanes.csv")
if not os.path.exists(raw_csv_path):
    # Fallback to NHANES directory path if not copied locally
...
print("\n" + "="*70)
print("CATBOOST 5-FOLD LEAKAGE-FREE CV RESULTS")
print("="*70)
